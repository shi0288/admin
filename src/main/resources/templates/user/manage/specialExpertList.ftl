...
<div class="panel-body">
    <ol class="breadcrumb">
        <li><a href="##">用户管理</a></li>
        <li class="active">专家侧边栏</li>
    </ol>
    <div class="well">
        <button type="button" tagVal="specialExpert" id="but_save_special" class="btn btn-primary" >
            保存
        </button>
    </div>
    <div class="row">
        <div class=" col-md-6 ">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" id="findExpertById" placeholder="用户ID" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" id="findExpertByName" placeholder="专家姓名" />
                    </div>
                </div>
            </div>
            <div class="well table-responsive">
                <table class="table">
                    ...
                    <#include  "/user/manage/specialListCom.ftl" />
                    </tbody>
                </table>
            </div>
        </div>
                ...
                <table class="table right_list">
                    ...
                    <#if (specialList)?? >
                        ...
                        <tr class="user_body">
                            ...
                            <td class="user_id" tagVal="${(e.uid)!''}">${(e.expert_name)!''}</td>
                            <td>
