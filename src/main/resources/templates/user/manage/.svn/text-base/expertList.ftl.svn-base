...
<div class="panel-body">
    ...
    <div class="well">
        <form class="table-filter" action="${base}/user/manage/expertList" method="post">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control" name="expert_name" value="${(user.expert_name)!''}" placeholder="专家姓名" />
                </div>
            </div>
...
<#if  (pager.list)??>
    ...
    <#assign parameterMap = {"uid":(user.uid)!,"expert_name":(user.expert_name)!} />
    <@p.pager pager = pager baseUrl = "${base}/user/manage/expertList" parameterMap = parameterMap/>
</#if>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
            <#include  "/user/manage/expertListCom.ftl" />
            </tbody>
        </table>
    </div>
