    ...
    <div class="col-md-4 pic_body">
        <div class="thumbnail thumb-gag"> <span class="label label-success lobel-tag">序号：<span class="pic_number">${e_index+1}</span></span>
            ...
            <div class="caption">
                ...
                <div class="form-group">
                    <label for="url_${e_index}">http地址</label>
                    <input type="text" class="form-control pic_url" id="url_${e_index}" value="${e.url}" placeholder="http地址" />
                </div>
                <div class="form-group">
                    <label for="app_url_${e_index}">app地址</label>
                    <input type="text" class="form-control pic_app_url" id="app_url_${e_index}" value="${e.appUrl}" placeholder="app地址" />
                </div>
                </p>
                <p>
